<?php include 'includes/header.php';?>
    ...
    <div class="flex justify-center items-center my-10">
        <form action="" method="POST" class="bg-gray-100 p-10 rounded shadow">
            ...
            <button type="submit" name="register" class="w-full p-2 my-5 bg-blue-500 text-white font-bold">Register</button>
            <div class="my-5">
...
if(isset($_POST['register'])){
    ...
    if($password == $cpassword){
        ...
        $qry = "INSERT INTO users (name, email, password) VALUES ('$fullname', '$email', '$password')";
